...
#pragma warning restore CS0649 
    ...
    [DllImport("Arctic/Misc/discord-rpc.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_Initialize")]
    ...
    [DllImport("Arctic/Misc/discord-rpc.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_Shutdown")]
    internal protected static extern void Shutdown();

    [DllImport("Arctic/Misc/discord-rpc.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_RunCallbacks")]
    internal protected static extern void RunCallbacks();

    [DllImport("Arctic/Misc/discord-rpc.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_UpdatePresence")]
    internal protected static extern void UpdatePresence(ref DiscordRpc.RichPresence presence);

    [DllImport("Arcticrnal/Misc/discord-rpc.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_ClearPresence")]
    internal protected static extern void ClearPresence();

    [DllImport("Arctic/Misc/discord-rpc.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "Discord_Respond")]
